    ...
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-2/3">
            <div className="flex items-center">
              <h1 className="text-3xl font-bold text-blue-600">Dr. Akshay Anil Akulwar</h1>
            ...
            <div className="flex flex-wrap mt-2 gap-2">
              <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Colon and Rectal Surgeon</span>
              <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm font-medium">General Surgeon</span>
            </div>
            
            <p className="text-gray-600 mt-3">MBBS, MS General Surgery, Masters in Coloproctology, PhD in Minimal Access Surgery</p>
            ...
            <div className="flex items-center mt-6">
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <span className="font-semibold ml-2">99% Recommended</span>
                </div>
                <span className="text-gray-600 text-sm">(98 Ratings)</span>
              </div>
            </div>
            
            <div className="mt-4 inline-block bg-amber-50 text-amber-800 px-3 py-1 rounded-full text-sm font-medium">
              <span>45 patients enquired about the doctor in last 1 hour</span>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <a href="tel:+919876543212" className="bg-gradient-to-r from-green-500 to-green-600 text-white font-medium py-3 px-6 rounded-md shadow hover:shadow-md flex items-center">
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mb-10 bg-white p-6 rounded-lg shadow-sm">
        <p className="text-gray-800 leading-relaxed">
          Dr Akshay Anil Akulwar is a General Surgeon associated with Midas Multispeciality Hospital, Nagpur. He has 13 years of experience in Colorectal and Minimal Access Surgery and has worked as an expert in different cities in India. He was previously associated with Meditrina Institute of Medical Sciences, HCG NCHRI Cancer Hospital, Nagpur Maharashtra and Datta Meghe Institute of Higher Education and Research Sawangi Meghe, Wardha. Doctor Akshay Anil has contributed to handling numerous complex medical cases in several hospitals. He is known for his attention to accurate diagnosis and treating patients empathetically.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Colorectal Cancer Management</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Benign Colorectal Diseases</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Inflammatory Bowel Disease (IBD)</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Pelvic Floor Disorders</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Minimally Invasive Surgery (MIS)</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Laser Piles Surgery</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Sclerotherapy for Varicose Veins</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Inguinal Hernia Surgery</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Laser Fistula Surgery</h3>
            </div>
          </div>
          <div className="p-4 border border-gray-100 rounded-lg hover:shadow-md transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium">Stapler Surgery for Piles</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-10 bg-white p-6 rounded-lg shadow-sm">
        ...
        <FAQItem 
          question="What conditions does Dr. Akshay Anil Akulwar treat?" 
          answer="Dr. Akshay specializes in treating various colorectal and gastrointestinal conditions including colorectal cancer, piles, fistula, inflammatory bowel disease, pelvic floor disorders, and performing minimally invasive surgeries. He is particularly known for his expertise in colorectal cancer management and minimally invasive surgical techniques."
        />
        
        <FAQItem 
          question="Where does Doctor Akshay Anil Akulwar practice?" 
          answer="Dr. Akshay Anil Akulwar currently practices at Midas Multispeciality Hospital in Nagpur. He has previously been associated with Meditrina Institute of Medical Sciences, HCG NCHRI Cancer Hospital in Nagpur, and Datta Meghe Institute of Higher Education and Research in Wardha."
        />
        
        <FAQItem 
          question="How can I book an appointment with Dr. Akshay Anil Akulwar?" 
          answer="You can book an appointment with Dr. Akshay Anil Akulwar through our website, by calling our customer care at 1800 233 0000, or by visiting the hospital directly. Our platform offers hassle-free booking with the option to choose your preferred date and time slot."
        />
      </div>
    </main>
  );
