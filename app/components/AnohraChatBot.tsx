...
export default function AnohraChatBot() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
        ...
        <div className="bg-white rounded-lg shadow-xl w-80 sm:w-96 mb-4 border border-blue-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-cyan-400 px-4 py-3 flex justify-between items-center">
            <div className="flex items-center">
              <div className="h-10 w-10 relative mr-2 rounded-full overflow-hidden bg-white p-1 shadow-inner">
                <Image
      ...
      <button
        onClick={toggleChat}
        className={`relative bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center h-16 w-16 ${isOpen ? 'hidden' : ''}`}
        style={{ boxShadow: '0 0 15px rgba(59, 130, 246, 0.5)' }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full animate-ping opacity-75" style={{ animationDuration: '3s' }}></div>
